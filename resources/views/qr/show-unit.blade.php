...
@section('title', 'Unit QR Code | PARDS')
@section('page_title', 'Property Unit QR Code')
    ...
    <div class="row g-4">
        <div class="col-lg-5">
            <div class="dashboard-card p-4 h-100 text-center">
                <h2 class="h4 mb-2">{{ $property?->property_name }}</h2>
                <p class="text-muted mb-3">{{ $propertyUnit->serial_number }}</p>
        ...
        <div class="col-lg-7">
            <div class="dashboard-card p-4 h-100">
                <h3 class="h5 mb-4">Unit QR Code Details</h3>
